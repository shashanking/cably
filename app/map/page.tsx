...
export default function Home() {
  ...
  // Splash stays up until initial dataset+vendor fetch resolves.
  // Feature rendering progress (which can take seconds for big datasets)
  // shows in the in-page MapLoadingOverlay instead.
  const mapInitLoading = loadState.stage === 'idle' || loadState.stage === 'connecting' || loadState.stage === 'fetching'
  usePageLoading('map-init', mapInitLoading, loadState.currentLabel || 'Loading map datasets…')
